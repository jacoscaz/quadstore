...
const getCachedStrategy = (pattern) => {
    return strategyCache.get(pattern);
};
const setCachedStrategy = (pattern, strategy) => {
...
const addIndexMatch = (strategy, term, valueOrRange) => {
...
const populate = (pattern, indexTerms, strategy, store) => {
...
//# sourceMappingURL=strategy-generate.js.map