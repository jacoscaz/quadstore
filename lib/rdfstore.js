...
class RdfStore extends QuadStore {
  ...
  constructor(path, opts) {
    ...
    this._httpServerPort = opts.httpServerPort || '8883';
    this._httpServerAddr = opts.httpServerAddr || '127.0.0.1';
    this._httpServerBaseUrl = opts.httpServerBaseUrl || 'http://127.0.0.1:8883';
    this._httpServer = new HttpServer(this, {baseUrl: this._httpServerBaseUrl});
    this._httpServer.listen(this._httpServerPort, this._httpServerAddr);
    this._ldfClient = new ldfClient.FragmentsClient(this._httpServerBaseUrl + '/ldf#dataset');
  }
