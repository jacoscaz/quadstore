...
class JoinQuery extends AbstractQuery {
  ...
  _execute() {
    ...
    const equalComparator = store._createEqualComparator(this._parentTermNames, this._otherTermNames);
    const orderComparator = store._createOrderComparator(this._parentTermNames, this._otherTermNames);
